...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Asistencia Empleados</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <button class="btn btn-info new-modal-asistencia_empleado" data-id="0"><i class="fas fa-plus-circle" aria-hidden="true"></i> Nuevo</button>

              </div>
              <div class="card-body table-asistencia_empleado">
    ...
    <div class="modal fade" id="modal-form-asistencia_empleado">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class=" modal-body">
            <form class="form_asistencia_empleado" id="form_asistencia_empleado">
  ...
  <script src="view/js/js-asistencia_empleados.js"></script>
  <script>
